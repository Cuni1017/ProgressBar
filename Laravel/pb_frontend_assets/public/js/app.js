...
// import "./bootstrap";
// const App = () => {
//     return <div>This is from React</div>;
// };
...
var addProductToCart = function addProductToCart(productId, quantity) {
  var cart = getCart();
...
var updateProductToCart = function updateProductToCart(productId, newQuantity) {
  var cart = getCart();
  cart[productId] = newQuantity;
  saveCart(cart);
};
var alertProductQuantity = function alertProductQuantity(productID) {
  var cart = getCart();
  var quantity = parseInt(cart[productID]) || 0;
  alert("add id:".concat(productID, ", quantity:").concat(quantity));
};
var initAddToCart = function initAddToCart(productID) {
  var cart = getCart();
  console.log(cart);
